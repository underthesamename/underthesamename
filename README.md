...
* Developing **Bycard**
* Maintaining and improving **Revenge**
...
`Rust` `Authentication` `Backend` `Security`

---

### [Bycard](https://github.com/underthesamename/Bycard)

A modern card collection platform focused on cataloging, organization and collection management.

`Rust` `Full Stack` `Web`

---

### [Revenge](https://github.com/underthesamename/Revenge)

A Python project focused on automation and practical software development.
